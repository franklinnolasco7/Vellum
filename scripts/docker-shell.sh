...
# Match host GPU groups so WebKit can use hardware acceleration in the container.
...
# Missing group names can make WebKit drop the device permissions Docker granted.
